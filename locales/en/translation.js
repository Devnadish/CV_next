export  const enLang={
  abouteBtn: "Khalid",
  liveclenderBtn: "Calender",
  workgllaryBtn: "Price",
  hiremBtn: "depended on",
  FAQmeu: "FAQ",
  SiteSmple: "WebSites",
  takeAction: "Login please",
  login: "Login",
  register: "Register",
  SiteTmplate: "WebSite delivered",
  download: "Download",
  waitingForyou: "Waiting For You",
  himsg: "Hi..",
  iamKhalid: "I am khalid",
  develepor: "full-stack develpoer",
  develoerSince: "Since 1998",
  cvbtn: "CV",
  ...
  Analyt: "the needs of the site users first. If you do not know what users needs are, ask them. this principle is the foundation of everything i create.",
  Desig: "encompasses graphics and identity, strategy, website advertising, and motion. I work collaboratively and independently, I do so in friendship.",
  logottle: "Logo Design",
  devlopingtitle: "develpoing technology",
  desigtitle: "Design technology",
  uiux: "User technology User Experince",
  database: "Database Technology",
  // 2006_008: "Al Sorayai Group organized for curtains and carpets and completed an inventory and sales system using Visual Basic",
  // 1998_005: "Director of the Computer Department at Al-Quthmi  Group for Curtains and completed an accounting system, purchases, sales and personnel affairs serving 24 branches  around the Kingdom of Saudi Arabia using the Clipper language",
  // 2009_010: "founded the billiard club and focused on the club",
  // 2011_014: "I participated in the weekly newspaper and established the advertising management system , from A to Z",
  // 2005_illNow : "I am Free Lancer",
  smWor: "Social Media Design",
  uiuxWrk: "UI/UX",
  logoWrk: "Logo Design",
  menuWrk: "Menu Design",
  charahterWork: "Chaacter Design",
  pakagWork: "Pakageing Design",
  posteWork: "Poster Design",
  singbardWork: "Signboard Design",
  cncWok: "CNC Work",
  coverork: "Cover Page Design",
  desgiWork: "Other Design",
  flyerork: "Flyer Design",
  IdenttiyWork: "Identitiy Design",
  InfogaghWork: "infographic design",
  liveclenderTitle: "Live Calender",
  workgllaryTitle: "Work Gallery",
  hiremTitle: "depended on",
  hiremlongTitle: "Thanx.. I will  back to you within 48 hours",
  firstameTitle: "First Name",
  lastnmeTitle: "Last Name",
  emailitle: "Email",
  phoneitle: "Phone",
  messaeTitle: "Subject",
  submiterTitle: "Submit",
  msgplceholder: "Give me Brief Information about your required",
  mailsbject: "Subject",
  sendMEmail: "Text Me Please",
  webWok: "Websites",
  ...
  perfomance: "Fast response and high performance",
  perfomanceTitle: "We ensure that your site works quickly and efficiently on all devices and screens.",
  ...
  freeConsultaion:"Free Consultaion",
  "smMenuTilte": "Social Media",
  "uiUxMenuTitle": "Ui/Ux",
  "identityMenuTitle": "Visual Identity",
  "mixedMenuTitl": "Mixed Media",
  "singBoardMEnuTitle": "Singboard",
  "cncMenuTitle": "Cnc Work",

  freeConsultaionTitle:"free consultation allows you to ask questions, discuss your concerns,explore your options without any financial commitment. It's a great opportunity",
  ...
  emrgecy: "Fast Contact ",
  khaliUrl: "/khalid-nadish",
  meTite: "I am Kalid Check My Profile",
  meBehnce: "Behance Profile",
  meLindn: "Linkden Profile",
  gettrtBtn: "Get Start",
  mailPaceholder: "Enter Your Email Address",
  ...
  S2L4:"Power of Reliable Tech",
  S2L5:"Unlock Your Potential: Grow Without Limits",
  S2L6:"The place for growth",
  S2L7:"Writing for Social Media: Tips for Success",
  S2L8:"Free technical support.",
  S2L9: "Introductory page of the site and its services",
  S2L10: "Planning Your Website: Tips and Best Practices",
  S2L12: "ssl security certificate",
  S2L13: "Enter site content",
  S2L11: "Enabling Multilingual ",
  S2L14: "Book Now",
  ...
  S8L1: "promote your business to the right audience",
  S8L2: " Promote your business and reach the right audience",
  S8L3: "SEO solution",
  S8L4: "WhatsApp Ads",
  S8L5: "Email campaigns",
  S8L6: "Social posts ",
  S8L7: "Social media Campaigns",
  S8L8:"Autorized BackLink",
  S8L9: "SMS campaigns",
  ...
  S101: "How to create a free website",
  ...
  S10L1: " Add an online store, booking system, members area and blog.",
  S10L1: "Publish your website and go live",
  S10L1: "Start building your professional online presence.",
  S10L1: ">Drive traffic to your site",
  S10L1: "Use advanced SEO tools and integrated marketing solutions",
  S11L1: "Get inspired, see what’s trending",
  S11L2: "eCommerce",
  ...
  S14L1: "How can I make sure my data and my visitors’ data is secure?",
  S14L2: "At Wix, we take care of security for you. With every site you get enterprise-grade security. From threat prevention to real-time detection and rapid response, security is fully managed by our dedicated team of experts—24/7. This includes data encryption in transit using HTTPS, TLS 1.2+ and an automatic SSL certificate.",
  S14L3: "How do I create a free website with a custom domain?",
  S14L4: "You can create a free website with Wix that comes with a Wix domain. To instantly look more professional online, get a custom domain name. It adds credibility to your brand and helps visitors find you online. You can start building your brand by using your domain in a custom email address (info@mystunningwebsite.com), your social channels, email marketing campaigns and more. For inspiration use our Business Name Generator.",
  S14L5: "How can I optimize my site for SEO on Wix?",
  S14L6: "All Wix sites come with best-practice SEO defaults, including utilizing server-side rendering, customizable meta tags for all site pages, structured data markup, dynamic XML sitemaps, and more. Plus, you get a suite of built-in SEO tools to help you compete in organic search. Learn more.",
  S14L7: "Can I use a website builder to create a landing page?",
  S14L8: "Yes. You can create any kind of website with Wix. Explore beautiful HTML landing page templates in the landing page builder to get started.",
  S14L9: "Is my site optimized for Core Web Vitals (CWV)?",
  S14L10: "Every new feature, component and element that we create is built with performance in mind, so no matter what type of business you have, you can create a high-performance website. Over the past year, we’ve managed to achieve dramatic improvements for CWV and increased the ratio of Wix sites in the Google CrUX report with good scores for all three CWV by over 10x. To learn more about how Wix prepared for CWV, check out this webinar we hosted with Google.",
  S14L11: "How can I design a logo for my website for free?",
  S14L12: "You can design your own logo for free with the intuitive Wix Logo Maker. Any logo you create is ready to go in high resolution for digital or print so your brand stays consistent.",
  moreMAiltitle:"if you need more info send me email !!",
  moreMAilbtn:"Send",
  moreMAilemail:"Email",
  moreMAilplaceholder:"Enter your email"
