...
const AdvertisingText = async ({ lang }) => {
    ...
    return (
        <>
            <div className='flex h-full w-[calc(100%-15px)] animate-pulse flex-col items-center justify-center gap-4 rounded-xl bg-orange-500 p-4 shadow-xl duration-2000 hover:bg-blue-700 hover:text-white hover:shadow-none'>
